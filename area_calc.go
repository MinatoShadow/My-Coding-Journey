...
func AreaCalculator() {
	...
	fmt.Print("Enter Length: "); fmt.Scan(&length) // Asking for length
	fmt.Print("Enter Breadth: "); fmt.Scan(&breadth) // Asking for breadth
	fmt.Print("Enter Unit: "); fmt.Scan(&unit) // Asking for unit
